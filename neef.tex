...
\begin{enumerate}
\item External datasets to join
\item Advertising research to develop new measures
\item Experiment designs for assessing NEEF's effectiveness
\end{itemize}

After working in these groups for a few hours,
we regrouped and focused further on
identifying relevant external and internal datasets,
documenting relevant statistical concerns.%\footnote{%
%We felt that there were simpler approaches
%than running advertising-based studies.}
